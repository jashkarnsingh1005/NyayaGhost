    ...
    if (request.method === 'POST' && pathname === '/generate') {
      try {
        ...
        const htmlContent = `
          ...
          <head>
            <meta charset="UTF-8">
            <title>NyayaGhost SOS Media</title>
            <style>
              body {
                background: #121212;
                color: #fff;
          ...
          <body>
            ...
            <p style="color:#888; font-size: 0.9em;">Page generated by NyayaGhost. If you see a 404 for media, it has expired for safety reasons.</p>
          </body>
          </html>
        `;
