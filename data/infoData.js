...
- Document incidents of abuse using NyayaGhost if it is safe to do so.
...
- **Tinkle Friend (For Children aged 7–12):**  
  ...
  {
    icon: 'info',
  label: 'How to keep NyayaGhost hidden',
  fullText: `NyayaGhost is designed to be discreet. Here are some ways to help keep it private on your device:
...
* This allows you to leave the app discreetly, even mid-use.`,
  ...
  {
    icon: 'info',
  label: 'NyayaGhost Guide',
    fullText: `## Essentials

  **Disguised Entry**  
  To open NyayaGhost, tap the calculator icon inside the Notes homepage or any note screen. Enter your PIN and press '=' to unlock.
  ...
  **Forgot Your PIN?**  
  ...
  &nbsp; 
  For your safety, if biometrics are disabled, you have no way to recover your PIN. To continue using NyayaGhost, you have to reinstall the app, and all data will be erased. Please remember your PIN carefully. You can enable biometrics under Settings → Privacy.
  ...
  **Android**  
  - Use your device’s Secure Folder (e.g. Samsung Secure Folder) to rename or hide NyayaGhost.
  &nbsp; 

  **Media Journal**  
  NyayaGhost can automatically delete your media after a set time. Configure this under Settings → Privacy → Auto-Wipe.  
  &nbsp; 
